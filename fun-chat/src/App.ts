...
class App {
  ...
  constructor() {
    // alert(
    //   "Доброго времени суток, проверяющий. Мне очень жаль, что Вы видете это сообщение, ведь если вы его видите, значит я что-то не успел доделать. Прошу дать чуть больше времени, если возможно или быть на связи, в случае изменения кода. Это все с Вашего позволения",
    // );
    this.api = new API();
